...
|---|---|---|
| 00 flour (Tipo 00) | 200g | Caputo "Chef's Flour" (red bag) |
| Whole eggs | 2 (≈100g) | Room temp |
| Egg yolks | 1 (≈17g) | Extra yolk = richer, more golden |
| Fine salt | 2g | Into the dough |
| Semolina or extra flour | 30g | For dusting cut pasta |

**Technique (stand mixer):**
1. Flour + salt in mixer bowl, paddle attachment
2. Eggs + yolk in the well, mix on low until shaggy (1–2 min)
3. Switch to dough hook, knead on medium-low 8–10 min until smooth, elastic, springs back when poked
4. Wrap tight in plastic, rest 30 min minimum at room temp — gluten must relax or it fights you when rolling
5. Flour surface generously, roll with pin to ≈2mm thick — rotate the sheet, don't stretch it
6. Lightly flour the sheet, fold loosely, cut 2–3mm strips for tonnarelli (or wider for fettuccine)
7. Toss cut pasta in semolina to prevent sticking, nest loosely on a tray

### Carbonara

| Ingredient | Amount | Notes |
|---|---|---|
| Fresh pasta (from above) | All of it | |
| Guanciale | 100g | Deli counter — if unavailable, pancetta (not bacon) |
| Pecorino Romano DOP | 60g | Finely grate on Microplane right before use |
| Egg yolks | 4 (≈68g) | Large eggs, room temp |
| Whole egg | 1 (≈50g) | Room temp |
| Black peppercorns | 5g | Coarsely crack in mortar or towel+pan — NOT pre-ground |
| Kosher salt (for pasta water) | 30g | For 3L water (1% by weight) |
| Water for pasta | 3000g (3L) | Less water = starchier water = better emulsion |

**Technique:**
1. Render guanciale from cold pan, medium-low, 8–10 min until glassy/crispy
2. Crack pepper into the guanciale fat (blooms the piperine)
3. Mix egg yolks + whole egg + grated Pecorino + cracked pepper in a bowl
4. Cook fresh pasta 2–3 min only (it's fresh, not dried)
5. Reserve 150g pasta water before draining
6. Pasta into guanciale pan OFF HEAT
7. Add egg/cheese mixture + 60–80g pasta water, toss vigorously
8. Residual heat cooks the egg to 65–70°C (silky, not scrambled)

**Critical:** No cream. Ever. The sauce is egg yolk + cheese + pasta water, emulsified by heat control.
...
| Ingredient | Amount | Notes |
|---|---|---|
| Baby arugula | 80g | Washed, dried completely (spinner or towels) |
| Parmigiano-Reggiano | 30g | Shaved with peeler, not grated |
| Pine nuts | 20g | Toast in dry pan 2–3 min until golden, watch closely |
